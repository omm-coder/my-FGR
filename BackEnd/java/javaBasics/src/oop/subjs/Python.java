...
public class Python {
    ...
    public Python() {
        this.course_work1 = 0.0;
        this.term_marks = 0.0;
        this.course_work2 = 0.0;
        this.final_marks = 0.0;
    }
    public Python(double course_work1, double term_marks, double course_work2, double final_marks) {
    ...
    public double pythonTotalMarks() {
